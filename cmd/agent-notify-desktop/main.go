...
func NewApp() (*App, error) {
	...
	svc, e := bridge.NewService(bridge.Options{ConfigPath: cp, StatePath: sp, LogPath: lp, BinaryPath: common.ResolveBinaryPath("")})
	if e != nil {
		return nil, e
	}
...
func (a *App) Events() ([]interface{}, error) {
	events, err := a.service.ListEvents(100)
	if err != nil {
		return nil, err
	}
...
func main() {
	...
	if err := wails.Run(&options.App{Title: "Agent Notify", Width: 980, Height: 700, AssetServer: &assetserver.Options{Assets: assets}, Bind: []interface{}{app}}); err != nil {
		os.Exit(1)
	}
}
