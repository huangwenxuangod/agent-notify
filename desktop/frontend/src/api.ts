...
export type WechatIlinkStatus={LoggedIn:boolean;Bound:boolean;SessionExpired?:boolean;UserID?:string;QRURL?:string;QRDataURL?:string;Status?:string;LastDeliveryAt?:string;LastDeliveryError?:string};
